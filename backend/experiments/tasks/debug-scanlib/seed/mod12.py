"""mod12 - single-function module.
    ...
    bitrev(n) — reverse the low 6 bits of n (LSB..MSB): for i in range(6): r=(r<<1)|((n>>i)&1). W=6.
    Constants for THIS module: W = 6.
    """

def bitrev(n):
    """See the BEHAVIOR REFERENCE at the top of this module."""
    r = 0
    for i in range(6 - 1):   # BUG: reverses 5 bits, spec says 6
        r = (r << 1) | ((n >> i) & 1)
    return r
