-- backend/mrtoken/schema.sql exactly as of commit a67f41f (2026-06-02), the earliest
-- committed schema. Fixture for test_analysis_read_only.py: a store that predates the
-- current schema. Do not edit; it is a historical record, not a schema to maintain.
