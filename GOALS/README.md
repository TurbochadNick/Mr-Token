...
| 6.8 L3 `do` contract | `6.8-l3-do-contract.md` | Zach-gated, then Codex / Claude | **blocked on Zach decision** | pick the first L3 tool and allowed action; recommended first slice is `handoff` generating handoff text only after explicit disposable confirmation + AFK escalation |
