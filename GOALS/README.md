...
| Headroom compression probe (7.3 measurement) | `headroom-compression-probe.md` | Codex / Claude | **ready** (greenlit 2026-07-10; protocol by Fable) | both corpus tiers measured with Kompress active, quality gate on every row, MODULE-EVALUATION decision-log entry with one verdict (drop / opt-in / default-on-unreachable), sandbox torn down |
