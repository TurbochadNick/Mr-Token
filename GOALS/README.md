...
| Headroom compression probe (7.3 measurement) | `headroom-compression-probe.md` | Codex / Claude | **done — drop** (2026-07-10) | Kompress measured on both tiers; all 40 rows failed reversible CCR quality (no retrieval markers), so none recorded and sandbox torn down |
