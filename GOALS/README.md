...
| Explicit disposability channel (`disposable_confirmed`) | `disposable-confirmed-channel.md` | Codex / Fable | **ready after PR #19 review** | agent can confirm droppability via toolbox; fresh confirmation → ask/do escalation works end-to-end; stale/absent → tell-only; tests green. Precondition for 6.8 L3. |
